                ...
                <div class="sign-in">
                    ...
                    <div class="sign-in-driver">
                        ...
                        <?php if($APP_TYPE == 'UberX' || $APP_TYPE == 'Ride-Delivery-UberX'){?>
                            <span><a href="provider-login"><?= $langage_lbl['LBL_SIGNIN_DRIVERSIGNIN'];?><img src="assets/img/arrow-white-right.png" alt="" /></a></span>
                        <?php } else { ?>
                    ...
                    <h3><?=$langage_lbl['LBL_SIGNIN_RIDER'];?></h3>
                        ...
                        <?php if($APP_TYPE == 'UberX' || $APP_TYPE == 'Ride-Delivery-UberX'){?>
                            <span><a href="user-login"><?=$langage_lbl['LBL_SIGNIN_RIDER_SIGNIN'];?><img src="assets/img/arrow-white-right.png" alt="" /></a></span>
                        <?php } else { ?>
