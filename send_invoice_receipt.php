   ...
   $mailcont_member_trips_img ='';
	 ...
	 if($db_trip['eType'] == 'UberX' && ($db_trip['vBeforeImage'] != '' || $db_trip['vAfterImage'] != '')){
		 	...
		 	$mailcont_member_trips_img='<table style="border-spacing:0;border-collapse:collapse;vertical-align:top;text-align:left;width:100%;color:#959595;line-height:14px;padding:0">
				...
				<tbody><tr><td><span style="font-size:14px;text-transform:uppercase">'.$vLabel_user_mail['LBL_SERVICE_BEFORE_TXT_ADMIN'].'</span><br></td</tr>

			<tr style="vertical-align:top;text-align:left;width:100%;padding:0" align="left">';

			if($db_trip['vBeforeImage'] != '') {

									$vBeforeImage=explode(";",rtrim($db_trip['vBeforeImage'],";"));
															$vBeforeImageComments=explode(";",rtrim($db_trip['vBeforeImageComments'],";"));

															$data_Label = $obj->MySQLSelect("SELECT `Label` FROM `images_labels` WHERE  `Sub_Category_Id`='".$db_trip['iVehicleCategoryId']."' and Type='Before'");
for ($i=0; $i <count($vBeforeImage) ; $i++) { 
			...
			$mailcont_member_trips_img .='<td style="word-break:break-word;border-collapse:collapse!important;vertical-align:top;text-align:center;display:table-cell!important;width:33%!important;line-height:16px;padding:6px 10px 10px" align="center" valign="top">
					...
					<span style="font-size:9px;text-transform:uppercase;float: left;">'.$data_Label[$i]['Label'].'</span><br>

					<span style="font-size:13px;color:#111125;font-weight:normal">

					<a href="'.$tconfig['tsite_upload_trip_images'].$vBeforeImage[$i].'" target="_blank"><img src="'.$tconfig['tsite_upload_trip_images'].$vBeforeImage[$i].'"  style="outline:none;text-decoration:none;float:left;clear:both;display:block" align="left" height="100" width="100" class="CToWUd"></a>

					</span><br><label style="float: left;margin-top: 10px;margin-right: 50%">'.$vBeforeImageComments[$i].'</label>
			...
			if($db_trip['vAfterImage'] != '') {
				$mailcont_member_trips_img .='</tr><tr><td><span style="font-size:14px;text-transform:uppercase">'.$vLabel_user_mail['LBL_SERVICE_AFTER_TXT_ADMIN'].'</span><br></td</tr>
				<tr style="vertical-align:top;text-align:left;width:100%;padding:0" align="left">';

$vAfterImage=explode(";",rtrim($db_trip['vAfterImage'],";"));
															$vAfterImageComments=explode(";",rtrim($db_trip['vAfterImageComments'],";"));
$data_Label = $obj->MySQLSelect("SELECT `Label` FROM `images_labels` WHERE  `Sub_Category_Id`='".$db_trip['iVehicleCategoryId']."' and Type='After'");
			...
			$mailcont_member_trips_img .='<td style="word-break:break-word;border-collapse:collapse!important;vertical-align:top;text-align:center;display:table-cell!important;width:33%!important;line-height:16px;padding:6px 10px 10px" align="center" valign="top">
					...
					<a href="'.$tconfig['tsite_upload_trip_images'].$vAfterImage[$i].'" target="_blank"><img src="'.$tconfig['tsite_upload_trip_images'].$vAfterImage[$i].'"  style="outline:none;text-decoration:none;float:left;clear:both;display:block" align="left" height="100" width="100" class="CToWUd"></a>

					</span><br><label style="float: left;margin-top: 10px;margin-right: 50%">'.$vAfterImageComments[$i].'</label>
				...
				<tbody>
					...
					<tr style="vertical-align:top;text-align:left;width:100%;padding:0" align="left">
						...
						<td style="word-break:break-word;border-collapse:collapse!important;vertical-align:top;text-align:left;display:inline-block;width:100%;padding:0" align="left" valign="top">
							...
							</table>'.$mailcont_member_trips_img.'	
...
*/			//echo "<pre>";print_r($db_trip);echo "</pre>";
		 ...
		 if($db_trip['eType'] == 'UberX' && ($db_trip['vBeforeImage'] != '' || $db_trip['vAfterImage'] != '')){
		 	...
		 	$mailcont_member_trips_img ='<table style="border-spacing:0;border-collapse:collapse;vertical-align:top;text-align:left;width:100%;color:#959595;line-height:14px;padding:0">
				...
				<tbody><tr><td><span style="font-size:14px;text-transform:uppercase">'.$vLabel_admin_mail['LBL_SERVICE_BEFORE_TXT_ADMIN'].'</span><br></td</tr>
...
for ($i=0; $i <count($vBeforeImage) ; $i++) { 
			...
			if($db_trip['vAfterImage'] != '') {
				$mailcont_member_trips_img .='</tr><tr><td><span style="font-size:14px;text-transform:uppercase">'.$vLabel_admin_mail['LBL_SERVICE_AFTER_TXT_ADMIN'].'</span><br></td</tr><tr style="vertical-align:top;text-align:left;width:100%;padding:0" align="left">';
