                        ...
                        <div class="form-group">
                            ...
                            <form id="_vehicleType_form" name="_vehicleType_form" method="post" action="" enctype="multipart/form-data">
                                ...
                                <?php if ($app_type_service == 'UberX') { ?> 
                                  ...
                                  <div class="row">
                                        <div class="col-lg-12">
                                            <label>Service Fee Type<span class="red"> *</span> <i class="icon-question-sign" data-placement="top" data-toggle="tooltip" data-original-title='This is Service Fee Type that will go to site for each job.'></i></label>
                                        </div>
                                        <div class="col-lg-6">
                                            <select required class="form-control" name="ServiceFeeType" id="ServiceFeeType">
                                                ...
                                                <option value="4" <?php if ($ServiceFeeType=='4') {
                                                   echo 'selected';
                                                } ?>>Revenue Share and Fixed Fee</option>
...
$("#FixedCommisionlabel").text('Fixed Fee');
