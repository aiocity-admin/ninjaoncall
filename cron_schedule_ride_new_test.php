<?php
	...
	//include_once('generalFunctions_test.php');
  ...
  $uuid = "fg5k3i7i7l5ghgk1jcv43w0j41";
	...
	$ToDate = date('Y-m-d');
	//$sql1 = "SELECT iCabBookingId,iCronStage,eAssigned,dBooking_date,vTimeZone FROM cab_booking WHERE eStatus='Pending' AND dBooking_date LIKE '%$ToDate%' AND eAutoAssign = 'Yes' AND iCronStage != '3' AND eAssigned='No' AND iCabBookingId = '285'";
