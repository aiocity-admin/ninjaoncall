                ...
                <form name="frmsignup" id="frmsignup" method="post" action="">
                    <div class="contact-form"> 
                        ...
                        <b>
                            ...
                            <span class="newrow"><strong>
                              <input type="text" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" placeholder="<?=$langage_lbl['LBL_CONTECT_US_EMAIL_LBL_TXT']; ?>" name="vEmail" value="" autocomplete="off" class="contact-input "/></strong></span>
