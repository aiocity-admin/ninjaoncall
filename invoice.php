        ...
        <div class="page-contant-inner">
					<div class="row">
						<div class="col-lg-12">
							<h2>Invoice</h2>
							<!-- <a href="mytrip.php">-->
                      <!--       <input type="button" class="btn button11 add-btn" style="float: right;" value="Close" onClick="javascript:window.top.close();"> -->
							<!-- </a> -->
					...
					<div class="table-list">
						<div class="row">
							<div class="col-lg-12">
                                ...
                                <div><?php echo $generalobj->clearName($db_trip_data['DriverDetails']['vName']." ".$db_trip_data['DriverDetails']['vLastName']); ?></div>
																<div><?php echo $generalobj->clearEmail($db_trip_data['DriverDetails']['vEmail']); ?></div>
															</div>
														</div>
														<div class="col-sm-6">
															<div class="left col-sm-3"> 
                                ...
                                <div><?php echo $generalobj->clearName($db_trip_data['PassengerDetails']['vName']." ".$db_trip_data['PassengerDetails']['vLastName']); ?></div>
																<div><?php echo $generalobj->clearEmail( $db_trip_data['PassengerDetails']['vEmail']); ?></div>
															</div>
														</div>
													</div>
												<? } ?>
...
for ($i=0; $i <count($vBeforeImage) ; $i++) { 
	if (($i+1)%6==0) {
		...
		# code...
															...
															?>
															<div class="col-sm-2">	
															<b><label><?=$data_Label[$i]['Label'];?></label><br><a href="<?= $tconfig['tsite_upload_trip_images'].$vBeforeImage[$i]; ?>" target="_blank" ><img src = "<?= $tconfig['tsite_upload_trip_images'].$vBeforeImage[$i]; ?>" style="width:200px;" alt ="Before Images"/></a></b>
...
<a href="<?= $tconfig['tsite_upload_trip_images'].$vAfterImage[$i]; ?>" target="_blank" ><img src = "<?=$tconfig['tsite_upload_trip_images'].$vAfterImage[$i]; ?>" style="width:200px;" alt ="After Images"/></a></b><span><?=$vAfterImageComments[$i];?></span>
		...
		# code...
										...
										<!-- 	<div class="row invoice-email-but">
												<span>
													<a href="send_invoice_receipt.php?action_from=mail&iTripId=<?= $db_trip_data['iTripId']?>"><button style="float: right;margin-right: 50px;" class="btn btn-primary ">E-mail</button></a>
												</span>
											</div> -->
										</div>
									</div>
