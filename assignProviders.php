...
//end select vehicle details

//insert vehicle against the muliple providers and delete inserted vehicle
...
//End insert vehicle against the muliple providers
echo "Vehicles has been assigned successfully.";
