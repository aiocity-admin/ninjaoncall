...
<!-- Second Section -->
        <div class="home-hero-page">
            <div class="home-hero-page-left" style="background: rgba(0, 0, 0, 0) url('<?=$tconfig["tsite_upload_page_images"].$homepage_banner["vImage"];?>') no-repeat scroll center top / cover ">
                <div class="home-hero-page-left-text"> 
                    <span>
                        <a href="sign-up"><?php echo $langage_lbl['LBL_SIGN_UP'];?></a>
            ...
            <div class="home-hero-page-right">
                <div class="home-hero-page-right-text">
                    <span>
                        ...
                        <a href="sign-up-rider"><?=$langage_lbl['LBL_SIGN_UP']; ?></a>
                    </span>
                </div>
            </div>
        </div>
        ...
        <div class="tap-app-ride">
            <div class="tap-app-ride-inner">
                <h3><?php echo $meta1['page_title'];?></h3>
                <h2><?=$langage_lbl['LBL_HOMEPAGE1_H2']; ?></h2>
                <?php echo $meta1['page_desc'];?>
               <span><a href="about-us"><?=$langage_lbl['LBL_HOMEPAGE1_LINK']; ?></a><i class="fa fa-chevron-right"></i></span>
        ...
        <div class="people-going-way">
            ...
            <div class="people-going-way-mid">
                <div class="people-going-way-mid-inner">
                    ...
                    <h2><?=$langage_lbl['LBL_HOMEPAGE2_H2']; ?></h2>
                    <?php echo $meta2['page_desc'];?>
                    <div><span><a href="about-us"><?=$langage_lbl['LBL_HOMEPAGE2_LINK']; ?><i class="fa fa-arrow-right"></i></a></span></div>
                    <div style="clear:both;"></div>
                </div>
            </div>
        ...
        <div class="helping-cities">
            ...
            <div class="helping-cities-mid">
                <div class="helping-cities-mid-inner">
                    ...
                    <h2><?=$langage_lbl['LBL_HOMPAGE_HELP_CITY']; ?></h2>
                    <?php echo $meta3['page_desc'];?>
                    <div><span><a href="about-us"><?=$langage_lbl['LBL_HOMEPAGE_HELP_CITY_LINK']; ?><i class="fa fa-arrow-right"></i></a></span></div>
                    <div style="clear:both;"></div>
                </div>
            </div>
            ...
            <div class="Safety-people-right">
                <div class="Safety-people-right-inner">
                    <div class="Safety-people-text">
                        ...
                        <h2><?=$langage_lbl['LBL_HOMEPAGE4_H2']; ?></h2>
                        <?php echo $meta4['page_desc'];?>
                        <div><span><a href="trust-safty-insurance"><?=$langage_lbl['LBL_HOMEPAGE4_LINK']; ?><i class="fa fa-arrow-right"></i></a></span></div>
