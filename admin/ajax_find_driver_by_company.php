...
if(isset($company_id) && !empty($company_id)) {
	$sql = 	"select iDriverId,CONCAT(vName,' ',MiddleName,' ',vLastName) AS driverName,vEmail from register_driver WHERE eStatus != 'Deleted' AND iCompanyId = '".$company_id."'  order by vName ";
