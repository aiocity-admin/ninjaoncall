						...
						<div class="form-group">
							...
							<form method="post" name="_country_form" id="_country_form" action="">
								...
								<div class="row">
									...
									<div class="col-lg-6">
										<input type="text" maxlength="30" class="form-control" name="vCountry"  id="vCountry" value="<?=$vCountry;?>" placeholder="Country Name" >
									</div>
								</div>
								...
								<div class="row">
									...
									<div class="col-lg-6">
										<input type="text" maxlength="5" class="form-control" name="vCountryCode"  id="vCountryCode" value="<?=$vCountryCode;?>" placeholder="Country Code" >
									</div>
								</div>
								...
								<div class="row">
									...
									<div class="col-lg-6">
										<input type="text" maxlength="5" class="form-control" name="vPhoneCode"  id="vPhoneCode" value="<?=$vPhoneCode;?>" placeholder="Country Phone Code" >
									</div>
								</div>
								...
								<div class="row">
									...
									<div class="col-lg-6">
										<input type="text" maxlength="15" class="form-control" name="vEmergencycode"  id="vEmergencycode" value="<?=$vEmergencycode;?>" placeholder="Emergency Number" >
									</div>
								</div>
