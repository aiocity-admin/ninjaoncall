...
$vLicencePlateLabel= isset($_POST['vLicencePlateLabel']) ? $_POST['vLicencePlateLabel'] : '';
...
//Code edited FixedCommission,ServicefeeType
        ...
        `fWaitingFees` = '".$fWaitingFees."',
         `FixedCommission`='".$FixedCommision."',
                ...
                `vLicencePlateLabel`='".$vLicencePlateLabel."',
  ...
  $obj->sql_query("delete from ExtraFields where doc_masterid='".$id."' and vFor='vehicle_type'");
  $z=0;
  $i=0;
    ...
    if (count($db_data) > 0) {
        for ($i = 0; $i < count($db_master); $i++) {
            ...
            foreach ($db_data as $key => $value) {
                ...
                $vLicencePlateLabel=$value['vLicencePlateLabel'];
                $payment_type=$value['payment_type'];
                $is_payment_type=$value['is_payment_type'];
            }
        }

  $query = "SELECT * FROM ExtraFields WHERE doc_masterid = '" . $id . "'  and vFor='vehicle_type'";
                        ...
                        <div class="form-group">
                            ...
                            <form id="_vehicleType_form" name="_vehicleType_form" method="post" action="" enctype="multipart/form-data">
                                ...
                                <?php if ($APP_TYPE == 'UberX') { ?> 
									...
									<?php } ?>
                                    <?php if (($APP_TYPE == 'Ride-Delivery' || $APP_TYPE == 'Ride-Delivery-UberX') && $app_type_service != 'UberX' ) { ?> 
                             ...
                             <div class="row">
                                        <div class="col-lg-12">
                                            <label>Label for Licence Plate Number<span class="red"> *</span> <i class="icon-question-sign" data-placement="top" data-toggle="tooltip" data-original-title='Label for Licence Plate Number'></i></label>
                                        </div>
                                        <div class="col-lg-6">
                                        
                                                <input type="type" name="vLicencePlateLabel" id="vLicencePlateLabel" class="form-control" value="<?=$vLicencePlateLabel;?>" required>
...
<!-- code edited adding row for select ServiceFeeType -->
                                        <div class="row">
                                        <div class="col-lg-12">
		...
		<script>
			...
			window.onload = function () {
				...
				if (appTYpe == 'UberX' && eFareType == 'Regular') {
					$("#Regular_div2").show();
                        //code edited for display fare or not
					//$("#Regular_div1").show();
			...
			function get_faretype(val) {
				...
				if (appTYpe == 'UberX') {
					if (val == "Fixed") {
						...
						$("#iMaxQty").attr('required', 'required');
                     //codeEdited for required fields based on Calulate fare yes or not
