<?
	...
	$sql1 = "SELECT * FROM country WHERE eStatus = 'Active' ORDER BY vCountry ASC";
						...
						<div class="form-group">
							...
							<form method="post" action="" name="_state_form" id="_state_form" >
								...
								<div class="row">
									...
									<div class="col-lg-6">
										<input type="text" maxlength="30" class="form-control" name="vState"  id="vState" value="<?=$vState;?>" placeholder="State Name" >
									</div>
								</div>
								...
								<div class="row">
									...
									<div class="col-lg-6">
										<input type="text" maxlength="5" class="form-control" name="vStateCode"  id="vStateCode" value="<?=$vStateCode;?>" placeholder="State Code" >
									</div>
								</div>
								<!-- <div class="row">
									<div class="col-lg-12">
