...
".$driver_update."			`vColour` = '" . $vColour . "',
			...
			`vCountry`='".$vCountry."',
			`Barangay`='".$vBarangay."',
			`eHandiCapAccessibility` = '" . $eHandiCapAccessibility . "',$subQuery
			$rental_query
...
<div class="col-lg-6">
	<div class="row">
								...
								<div class="row">
									<div class="col-lg-12">
										<label id="lbl_plate_number"> License/Permit Number <span class="red">* </span></label>
									</div>
									<div class="col-lg-12">
...
<div class="col-lg-6">
   ...
   <div class="row">
											...
											<div class="col-lg-12">
												<select class="form-control" name = 'vCountry' id="vCountry" onChange="setState(this.value,'')" >
...
?>
	...
	<div class="row">
									...
									<div class="col-lg-12">
										<select name = "Province" id="Province" class="form-control" onChange="setCity(this.value,'');" >
													<option value="">Select</option>
												</select>
									</div>
								</div>
	                            ...
	                            <div class="row">
									<div class="col-lg-12">
										<label id="lbl_city">City/Municipality <span class="red"> </span></label>
									</div>
									<div class="col-lg-12">
	                             ...
	                             <div class="row" id="row_vBarangay">
									...
									<div class="col-lg-12">
										...
										<select name = "vBarangay" id="vBarangay" class="form-control">
											<option value="">Select</option>
								  ...
								  <div class="row">
									...
									<div class="col-lg-12">
										<textarea type="text" class="form-control" name="Owner_Address"  id="Owner_Address"   placeholder="House Number, Building Number, and Street Name"><?= trim($Owner_Address);?></textarea>
									</div>
								</div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
//codeEDITED FOR BARANGAY,city,country, address



  setState('<?php echo $vCountry; ?>','<?php echo $Province; ?>');
