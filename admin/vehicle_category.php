...
//Pagination End
if(!empty($eStatus)) { 
$sql = "SELECT vc.iVehicleCategoryId, vc.vLogo,vc.vCategory_".$default_lang." as vCategory, vc.eStatus, vc.iDisplayOrder, (select count(iVehicleCategoryId) from vehicle_category where iParentId = vc.iVehicleCategoryId) as SubCategories FROM vehicle_category as vc WHERE  vc.iParentId='0' $ssql $rdr_ssql $ord LIMIT $start, $per_page";
} else {
                                                ...
                                                <tbody>
													<?php if(!empty($data_drv)) { 
														...
														<td align="center" style="text-align:center;"><input type="checkbox" id="checkbox" name="checkbox[]" <?php echo $default; ?> value="<?php echo $data_drv[$i]['iVehicleCategoryId']; ?>" />&nbsp;</td>
															...
															<td><? echo $data_drv[$i]['vCategory']; ?></td>	
