...
$sql = "SELECT COUNT(iPageId) AS Total FROM pages WHERE ipageId NOT IN('5','20','21') AND eStatus = 'Active' $ssql";
...
//$sql = "SELECT * FROM ".$tbl_name."  WHERE eStatus != 'Deleted' $ssql $ord LIMIT $start, $per_page ";
 $sql = "SELECT iPageId,vPageName,vTitle,vPageTitle_".$default_lang.",tPageDesc_".$default_lang." FROM ".$tbl_name." where ipageId NOT IN('5','20','21') AND eStatus = 'Active' $ssql $ord LIMIT $start, $per_page ";
                                            ...
                                            <table class="table table-striped table-bordered table-hover">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="gradeA">
                                                        ...
                                                        <td><?= $data_drv[$i]['vPageTitle_'.$default_lang]; ?></td>
