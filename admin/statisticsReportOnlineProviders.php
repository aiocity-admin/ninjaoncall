...
date1= date1.getFullYear() + '-' +
 ...
 $.ajax({
           ...
           data: {"loadtime":seconds,"beforeload":date1,"afterload":date2,"UserType":"SUPER_ADMIN","eType":"STATISTICS_ONLINE_PROVIDERS"}, 
...
$script   = "statisticsReportOnlineProviders";
...
$VehicleCategory= trim($value['iVehicleCategoryId'])==""?$value['eType']:$value['iVehicleCategoryId'];
                                                  ...
                                                  <tr>
                                                       ...
                                                       <?php if($list!="Yes") { ?>
                                                 <td><a onclick="window.open('statisticsReportOnlineProviders.php?search=1&list=Yes&company=<?=$value['iCompanyId'];?>&keyword=<?=$value['vCompany'];?>&eStatus=Active&iVehicleCategoryId=<?=$VehicleCategory;?>','_blank')"><?=$value['numberofdriver'];?></a> </td>
<? } else {
?>
...
post('statisticsReportOnlineProviders.php', {search:1,providers:provider,company:company,iVehicleCategoryId:iVehicleCategoryId,list:list,sortby:sortby,order:order });
...
var sortby=$("#sortby").val();
var order=$("#order").val();
post('ExportStatisticsReport/exportOnlineProvides.php', {search:1,providers:provider,company:company,iVehicleCategoryId:iVehicleCategoryId,list:list,sortby:sortby,order:order });
...
$("#reset").click(function(){
  ...
  window.location.href="statisticsReportOnlineProviders.php";
});
