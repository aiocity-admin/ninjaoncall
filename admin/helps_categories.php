...
$sql = "SELECT COUNT(vTitle) AS Total FROM helps_categories WHERE 1=1 $ssql";
...
$sql = "SELECT * FROM ".$tbl_name." WHERE 1=1 $ssql $ord LIMIT $start, $per_page ";
...
<html lang="en">
    ...
    <head>
        <meta charset="UTF-8" />
        <title><?=$SITE_NAME?> | Hepls Category</title>
            ...
            <div id="content">
                <div class="inner">
                              ...
                              <tbody>
                                <tr>
                                    ...
                                    <td width="12%">
                                      ...
                                      <input type="button" value="Reset" class="btnalt button11" onClick="window.location.href='helps_categories.php'"/>
                                    </td>
                                    <td width="30%"><a class="add-btn" href="helps_categories_action.php" style="text-align: center;">Add Helps Category</a></td>
                                </tr>
                              </tbody>
                        </table>
                                            ...
                                            <table class="table table-striped table-bordered table-hover">
                                                ...
                                                <tbody>
													...
													for ($i = 0; $i < $count_all; $i++) { 
														...
														?>
														<tr class="gradeA">
															<td align="center" style="text-align:center;"><input type="checkbox" id="checkbox" name="checkbox[]" <?php echo $default; ?> value="<?php echo $data_drv[$i]['iHelpscategoryId']; ?>" />&nbsp;</td>
															...
															<td align="center" style="text-align:center;" class="action-btn001">
																<div class="share-button openHoverAction-class" style="display: block;">
																	...
																	<div class="social show-moreOptions openPops_<?= $data_drv[$i]['iHelpscategoryId']; ?>">
																		<ul>
																			<li class="entypo-twitter" data-network="twitter"><a href="helps_categories_action.php?id=<?=$iHelpscategoryId;?>" data-toggle="tooltip" title="Edit">
																				<img src="img/edit-icon.png" alt="Edit">
																			</a></li>	
																			
																			<li class="entypo-facebook" data-network="facebook"><a href="javascript:void(0);" onclick="changeStatus('<?=$iHelpscategoryId;?>','Inactive')"  data-toggle="tooltip" title="Make Active">
																				<img src="img/active-icon.png" alt="<?php echo $data_drv[$i]['eStatus']; ?>" >
																			</a></li>
																			<li class="entypo-gplus" data-network="gplus"><a href="javascript:void(0);" onclick="changeStatus('<?=$iHelpscategoryId;?>','Active')" data-toggle="tooltip" title="Make Inactive">
																				<img src="img/inactive-icon.png" alt="<?php echo $data_drv[$i]['eStatus']; ?>" >	
																			</a></li>
																			
																			<li class="entypo-gplus" data-network="gplus"><a href="javascript:void(0);" onclick="changeStatusDelete('<?=$iHelpscategoryId;?>')"  data-toggle="tooltip" title="Delete">
                    ...
                    <div class="admin-notes">
                            ...
                            <ul>
                                    <li>
                                            Helps Category module will list all Helps categories on this page.
                                    </li>
                                    <li>
                                            Administrator can Activate / Deactivate / Delete any Helps category.
                                    </li>
...
<form name="pageForm" id="pageForm" action="action/helps_categories.php" method="post" >
<input type="hidden" name="page" id="page" value="<?php echo $page; ?>">
<input type="hidden" name="tpages" id="tpages" value="<?php echo $tpages; ?>">
<input type="hidden" name="iHelpscategoryId" id="iMainId01" value="" >
