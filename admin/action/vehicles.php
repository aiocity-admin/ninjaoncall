...
$vLicencePlate_update=$db_data_vLicencePlate[0]['vLicencePlate'];
		...
		$query = "UPDATE driver_vehicle SET eStatus = 'Deleted' WHERE vLicencePlate = '" . $vLicencePlate_update . "'";
        $obj->sql_query($query);
...
$vLicencePlate_update=$db_data_vLicencePlate[0]['vLicencePlate'];
					...
					$query = "UPDATE driver_vehicle SET eStatus = '" . $status . "' WHERE vLicencePlate = '" . $vLicencePlate_update . "'";
	            	$obj->sql_query($query);
