...
if($checkbox != "" && $statusVal != "") {
	if(SITE_TYPE !='Demo'){
		...
		if($statusVal == 'Active') {
		$_SESSION['var_msg'] = 'Restricted Area(s) Activated successfully.';
            }else if($statusVal == 'Inactive')
{
		$_SESSION['var_msg'] = 'Restricted Area(s) Inactivated successfully.';
}
            else {
		$_SESSION['var_msg'] = 'Restricted Area(s) '. $statusVal.' successfully.';
            }
		//$_SESSION['var_msg'] = 'Restricted Area(s) '. $statusVal.' successfully.';
	}
	else{
