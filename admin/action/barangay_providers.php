...
if ($method == 'delete' && $iDriverId != '') {
	...
	header("Location:".$tconfig["tsite_url_main_admin"]."barangay_providers.php?".$parameters); exit;
}
//End make deleted
	...
	if(SITE_TYPE !='Demo'){
		...
		if(strtolower($status) == 'active'){
			...
			if(count($Data) == 0){
				...
				header("Location:".$tconfig["tsite_url_main_admin"]."barangay_providers.php?".$parameters);
				exit;
			}
		}
