...
$Reason=isset($_REQUEST['delete_reason']) ? $_REQUEST['delete_reason'] : '';
 //Start make deleted
...
$query="select vLicencePlate from driver_vehicle where iDriverVehicleId='$iDriverVehicleId'";
...
$vLicencePlate_update=$db_data_vLicencePlate[0]['vLicencePlate'];
	...
	header("Location:".$tconfig["tsite_url_main_admin"]."barangay_vehicles.php?".$parameters); exit;
}
//End make deleted
...
$vLicencePlate_update=$db_data_vLicencePlate[0]['vLicencePlate'];
					...
					$query = "UPDATE driver_vehicle SET eStatus = '" . $status . "',Reason='$Reason' WHERE vLicencePlate = '" . $vLicencePlate_update . "'";
	            	$obj->sql_query($query);
...
$vLicencePlate_update=$db_data_vLicencePlate[0]['vLicencePlate'];
        ...
        header("Location:".$tconfig["tsite_url_main_admin"]."barangay_vehicles.php?".$parameters);
        exit;
}
