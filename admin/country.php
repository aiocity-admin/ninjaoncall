...
<html lang="en">
    ...
    <head>
        ...
        <style>.admin-nir-table .button11{padding:9px 10px 8px 10px !important;}</style>
                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="admin-nir-table">
                              <tbody>
                                <tr>
                                    ...
                                    <td>
                                      <input type="submit" value="Search" class="btnalt button11" id="Search" name="Search" title="Search" style="margin-left:17px" />
