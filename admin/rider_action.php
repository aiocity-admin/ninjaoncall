...
$nortification_query="SELECT `Event`, `ActionBy`, `NotifyCompany`, `NotifyProvider`, `NotifyCustomer`, `NotifyAdministrator`, `AdditionalEmail` FROM `nortification_settings` WHERE `Event`='Passenger Signup' and  `ActionBy`='Super Admin'";
...
if ($action == 'Edit') {
    $sql = "SELECT iUserId,vName,vLastName,vEmail,vPassword,vPhone,vPhoneCode,vCountry,vInviteCode,eStatus,vImgName,vCurrencyPassenger,vLang,eGender,MiddleName,Suffix FROM " . $tbl_name . " WHERE iUserId = '" . $id . "'";
...
<html lang="en">
  ...
  <div class="row">
                                             ...
                                             <div class="col-lg-6">
                                                  <input type="text" class="form-control" name="Suffix"  id="Suffix" value="<?=$Suffix;?>" placeholder="Suffix" >
                                             </div>
                                        </div>
                                        <div class="row">
                                             <div class="col-lg-12">
