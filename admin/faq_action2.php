								...
								<div class="row">
									...
									<div class="col-lg-6">
										<?
											...
											$query1 = "SELECT iDisplayOrder FROM ".$tbl_name." WHERE iFaqcategoryId = ".$faq_cat_id." ORDER BY iDisplayOrder";
								...
								<? } else{ ?>
										<div class="row">
											...
											<div class="col-lg-6">
												...
												$data_order_sort1 = $obj->MySQLSelect($query1);
												foreach($data_order_sort1 as $value)
												{
