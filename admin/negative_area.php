...
<!--[if !IE]><!--> <html lang="en"> <!--<![endif]-->
	...
	<head>
		<meta charset="UTF-8" />
		<title>Admin | Negative area</title>
		...
		<div id="wrap">
			...
			<div id="content">
				<div class="inner">
					<div class="row">
						<div class="col-lg-12">
							<h2><?php echo "Negative Area";?></h2>
							<a href="negative_area_action.php">
								<input type="button" value="Add Negative Area" class="add-btn">
							</a>
						</div>
					</div>
				<? if ($success == 2) { ?>
														...
														if($count_all > 0) {
															...
															<tr class="gradeA">
																...
																<td class="center veh_act" width="20%">
																	<a href="negative_area_action.php?restricted_id=<?=$restricted_id;?>">
