...
$srch="";
if ((strpos($data_drv[$i]['ServiceFeeType'], 'Revenue Share Only') !== false) ) 
    $srch= '1'; 

 if ((strpos($data_drv[$i]['ServiceFeeType'], 'Fixed Fee Only') !== false) ) 
         $srch= '2';
      if ((strpos($data_drv[$i]['ServiceFeeType'], 'Revenue Share and Fixed Fee') !== false) ) 
           $srch= '4';
      

      if($iVehicleCategoryId != '') {
        $ssql.= " AND (vt.ServiceFeeType LIKE '%".$srch."%' OR  vt.eType LIKE '%".$keyword."%' OR  vt.FixedCommission LIKE '%".$keyword."%' OR vt.fCommision LIKE '%".$keyword."%' OR vt.vVehicleType_".$default_lang." LIKE '%".$keyword."%' OR vt.fPricePerKM LIKE '%".$keyword."%' OR vt.fPricePerMin LIKE '%".$keyword."%' OR vt.iPersonSize	 LIKE '%".$keyword."%') AND vt.iVehicleCategoryId = '".$iVehicleCategoryId."'";
      } else {
        $ssql.= " AND (vt.ServiceFeeType LIKE '%".$srch."%' OR vt.eType LIKE '%".$keyword."%' OR vt.FixedCommission LIKE '%".$keyword."%' OR vt.fCommision LIKE '%".$keyword."%' OR vt.vVehicleType_".$default_lang." LIKE '%".$keyword."%' OR vt.fPricePerKM LIKE '%".$keyword."%' OR vt.fPricePerMin LIKE '%".$keyword."%' OR vt.iPersonSize   LIKE '%".$keyword."%')";
      }
				...
				<td width="16%" class=" padding-right10">
					<select name="option" id="option" class="form-control">
                                          ...
                                          <?php if($Vehicle_type_name == 'Ride-Delivery'){ ?>
                                           <option value="vt.eType" <?php if ($option == 'vt.eType') {echo "selected"; } ?> >Category</option>
                                          <?php }?>
                                    </select>
                                    </td>
                                    <?php } else { ?>
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <table class="table table-striped table-bordered table-hover">
                                                <thead>
                                                   ...
                                                   <th width="12%">Service fees type </th>
                            <th width="12%">Revenue Fees </th>

														<th width="12%">Fixed Fees </th>
<!--                                                         <th width="12%">Commission (%)</th> codeEdited
 -->
														...
														<?php } ?>
                             <?php if($Vehicle_type_name == "Ride-Delivery"){ ?>
                            <th width="8%" align="center" style="text-align:center;">Category</th>
                             <?php } ?>
                                  ...
                                  <?php } ?>
                                                                         ...
                                                                         <td><?php switch ($data_drv[$i]['ServiceFeeType']) {
    case '1':
   ...
   /* case '3':
       echo 'Token Fee Only';
        ...
        break;   */    
                                                                         ...
                                                                         <td><?= $data_drv[$i]['FixedCommission'] ?></td>

																		 <td><?= $data_drv[$i]['iPersonSize'] ?></td>
																		 <?php if($Vehicle_type_name == "Ride-Delivery"){ ?>
																		 <td><?= $data_drv[$i]['eType']=='Deliver'?'Delivery':$data_drv[$i]['eType']; ?></td>
																		 <?php } ?>
                                    <?php } ?>
