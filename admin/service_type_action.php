...
$ServiceFeeType = isset($_POST['ServiceFeeType']) ? $_POST['ServiceFeeType'] : '';
$FixedCommision = isset($_POST['FixedCommision']) ? $_POST['FixedCommision'] : '';
$CalculateFare = isset($_POST['CalculateFare']) ? $_POST['CalculateFare'] : '1';

$payment_type= isset($_POST['payment_type']) ? $_POST['payment_type'] : '';
$is_payment_type= isset($_POST['is_payment_type']) ? $_POST['is_payment_type'] : '';


if (trim($ServiceFeeType)=='2')
 {
    $fCommision=0;
}
if (trim($ServiceFeeType)=='1')
 {
    $FixedCommision=0;
}
$vTitle_store = array();
...
//Code edited FixedCommission,ServicefeeType
        ...
        $query = $q . " `" . $tbl_name . "` SET
                ...
                `is_payment_type`='".$is_payment_type."',
...
/*            if ($message_print_id != "") {
    ...
    // $obj->sql_query($query);
    if ($action == "Add") {
        $_SESSION['var_msg'] = $langage_lbl_admin['LBL_SERVICE_TXT'] ." Type Add Successfully";
        $_SESSION['success'] = "1";
    } else {
        $_SESSION['var_msg'] = $langage_lbl_admin['LBL_SERVICE_TXT'] ." Type Updated Successfully";
        $_SESSION['success'] = "1";
    }
    ...
    if (count($db_data) > 0) {
        for ($i = 0; $i < count($db_master); $i++) {
            ...
            foreach ($db_data as $key => $value) {
                ...
                $FixedCommision=$value['FixedCommission'];
                $CalculateFare=$value['CalculateFare'];
                $payment_type=$value['payment_type'];
                $is_payment_type=$value['is_payment_type'];
            }
        }
    }
}
...
<!--[if !IE]><!--> <html lang="en"> <!--<![endif]-->
    ...
    <head>
        <meta charset="UTF-8" />
        <title>Admin | <?php echo $langage_lbl_admin['LBL_SERVICE_TXT']; ?> Type <?= $action; ?></title>
                    ...
                    <div class="body-div">
                        <div class="form-group">
                            ...
                            <div class="alert alert-success alert-dismissable msgs_hide">
                                ...
                                <?= $langage_lbl_admin['LBL_SERVICE_TXT']; ?> Type Updated successfully.
                            </div><br/>
                            <? } elseif ($success == 2) { ?>
                            ...
                            <form id="_vehicleType_form" name="_vehicleType_form" method="post" action="" enctype="multipart/form-data">
                                ...
                                <?php if ($app_type_service == 'UberX') { ?> 
                                            ...
                                            <select  class="form-control" name = 'iVehicleCategoryId' required onchange="getordering(this.value);">
                                               ...
                                               <!--  <option value = "<?php echo $db_data_cat[$i]['iVehicleCategoryId'] ?>" <?php echo ($db_data_cat[$i]['iVehicleCategoryId'] == $iVehicleCategoryId) ? 'selected' : ''; ?>><?php echo $db_data_cat[$i]['vCategory_'.$default_lang]; ?>
                                                ...
                                                for ($j = 0; $j < count($db_data2); $j++) {
                                                    ...
                                                    <?php if ($db_data2[$j]['iVehicleCategoryId'] == $iVehicleCategoryId)
                                                        echo 'selected'; ?> >
                                    ...
                                    <div class="row">
                                     <div class="col-lg-12">
                                          <label>Select Location <span class="red"> *</span> <i class="icon-question-sign" data-placement="top" data-toggle="tooltip" data-original-title='Select the location in which you would like to appear this Services. For example "car washing" services to appear for any specific city or state or may be for whole country. You can define these locations from "Manage Locations >> Geo Fence Location" section'></i></label>
                                     </div>
                                     <div class="col-lg-6">
                                ...
                                <div class="row">
                                        <div class="col-lg-12">
                                            <label> Display Fare<span class="red"> *</span> <i class="icon-question-sign" data-placement="top" data-toggle="tooltip" data-original-title='Calculate and display the fare or not.'></i></label>
                                        </div>
                                        <div class="col-lg-6">
                                            <select  class="form-control" name = 'CalculateFare' id="CalculateFare" required >
                                                <option value="">Select</option>
                                                 <option value="1" <?php if($CalculateFare==1||$CalculateFare=='1') echo "selected"; ?>>Yes</option>
                                                  <option value="0"  <?php if($CalculateFare==0||$CalculateFare=='0') echo "selected"; ?>>No</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <?php if ($app_type_service == "UberX") { ?> 
                                        ...
                                        <div class="row" id="row_eFareType">
                                            <div class="col-lg-12">
...
<!-- code edied adding row for select ServiceFeeType -->

                                  <div class="row">
                                        <div class="col-lg-12">
                                            <label>Platform Fee Type<span class="red"> *</span> <i class="icon-question-sign" data-placement="top" data-toggle="tooltip" data-original-title='This is Service Fee Type that will go to site for each job.'></i></label>
                                        </div>
                                        <div class="col-lg-6">
                                            <select required class="form-control" name="ServiceFeeType" id="ServiceFeeType">
                                                <option value="">Select</option>
                                                <option value="1" <?php if ($ServiceFeeType=='1') {
                                                   echo 'selected';
                                                } ?>>Revenue Share Only</option>

                                                <option value="2" <?php if ($ServiceFeeType=='2') {
                                                   echo 'selected';
                                                } ?>>Fixed Fee Only</option>

                                            <!--     <option value="3" <?php if ($ServiceFeeType=='3') {
                                                   echo 'selected';
                                                } ?>>Token Fee Only</option> -->

                                                <option value="4" <?php if ($ServiceFeeType=='4') {
                                                   echo 'selected';
                                                } ?>>Fixed Fee and Revenue Share</option>
                                         <!--    <option value="5" <?php if ($ServiceFeeType=='5') {
                                                   echo 'selected';
                                                } ?>>Revenue Share and Token Fee</option> -->

                                <option value="6" <?php if ($ServiceFeeType=='6') {
                                                   echo 'selected';
                                                } ?>>Quantity based Fixed Fee Only</option> 
                                            </select>

                                        </div>
                                    </div>
                                  <!--  Code edited adding row for Commsion,tokens  -->

                                 <div class="row" id="FixedCommisionDiv" style="display: none">
                                        <div class="col-lg-12">
                                            <label ><span id='FixedCommisionlabel'></span><span class="red"> *</span> <i class="icon-question-sign" data-placement="top" data-toggle="tooltip" data-original-title='This is fixed fee  that will go to site for each job.'></i></label>
                                        </div>
                                        <div class="col-lg-6">
                                            <input type="text" class="form-control" name="FixedCommision"  id="FixedCommision" value="<?= $FixedCommision; ?>"  >
                                        </div>
                                    </div>

                                    <div class="row" id="fCommisionDiv" style="display: none">
                                        <div class="col-lg-12">
                                            <label> Revenue Share (%)<span class="red"> *</span> <i class="icon-question-sign" data-placement="top" data-toggle="tooltip" data-original-title='This is % amount that will go to site for each job.'></i></label>
                                        </div>
                                        <div class="col-lg-6">
                                            <input type="text" class="form-control" name="fCommision"  id="fCommision" value="<?= $fCommision; ?>">
                                        </div>
                                    </div>

									   <!-- <div class="row" >
                                        <div class="col-lg-12">
                                            <label> Commision (%)<span class="red"> *</span> <i class="icon-question-sign" data-placement="top" data-toggle="tooltip" data-original-title='This is % amount that will go to site for each job.'></i></label>
                                        </div>
                                        <div class="col-lg-6">
                                            <input type="text" class="form-control" name="fCommision"  id="fCommision" value="<?= $fCommision; ?>">
                                        </div>
...
<div class="row">
     <div class="col-lg-12">
<label>Enable Payment Mode <span class="red"> *</span><i class="icon-question-sign" data-placement="top" data-toggle="tooltip" data-original-title="It will enabled the payment screen in user mobile app."></i></label>
                </div>                                                                                                                                                                <div class="col-lg-6">

<select class="form-control" name="is_payment_type" id="is_payment_type" required>
    <option value="">Select</option>

<option value="Yes" <?php if (strtolower(trim($is_payment_type))=="yes") echo "selected";?> >Yes</option>
<option value="No" <?php if (strtolower(trim($is_payment_type))=="no") echo "selected";?>>No</option>
</select>
                       </div>                                                 
</div>

<div class="row" id="payment_type_row" style="display: none">
     <div class="col-lg-12">
<label>Payment Mode <span class="red"> *</span><i class="icon-question-sign" data-placement="top" data-toggle="tooltip" data-original-title="Payment methods can be set through this option. Selecting Cash will give user to pay using cash only. Card will give option of only credit card and Cash-card option will give both cash and card option."></i></label>
                </div>                                                                                                                                                                <div class="col-lg-6">

<select class="form-control" name="payment_type" id="payment_type">
    <option value="">Select</option>

<option value="Cash" <?php if (strtolower(trim($payment_type))=="cash") echo "selected";?> >Cash</option>
<option value="Card" <?php if (strtolower(trim($payment_type))=="card") echo "selected";?>>Card</option>
<option value="Cash-Card" <?php if (strtolower(trim($payment_type))=="cash-card") echo "selected";?>>Cash-Card</option>
</select>
                       </div>                                                 
</div>
                                     ...
                                     <?php if ($app_type_service == "UberX") { ?> 
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6" id="change_order">
                                          <?
                                              $temp = 1;
                                    ...
                                    <div class="row">
                                            <div class="col-lg-12">
                                                <label> <?php echo $langage_lbl_admin['LBL_PASSANGER_TXT_ADMIN']; ?> Cancellation Charges  (Price In <?=$db_currency[0]['vName']?>)<span class="red"></span> <i class="icon-question-sign" data-placement="top" data-toggle="tooltip" data-original-title='<?php echo $langage_lbl_admin['LBL_PASSANGER_TXT_ADMIN']; ?> cancellation charges will be apply to the <?php echo $langage_lbl_admin['LBL_PASSANGER_TXT_ADMIN']; ?> when <?php echo $langage_lbl_admin['LBL_PASSANGER_TXT_ADMIN']; ?> cancels job. Cancellation charges will apply for credit card payment only.'></i></label>
                                            </div>
                                            <div class="col-lg-6">
                                   ...
                                   <div class="row">
                                        <div class="col-lg-12">
                                            <label> Waiting Time Limit ( in minute )<span class="red"></span> <i class="icon-question-sign" data-placement="top" data-toggle="tooltip" data-original-title='Waiting charge will be applied if duration increase than the defined one after <?php echo $langage_lbl_admin['LBL_DRIVER_TXT_ADMIN']; ?> mark as Arrived from the app. So let say if its set to 5 minutes then the defined waiting charge will be applied in total fare when <?php echo $langage_lbl_admin['LBL_DRIVER_TXT_ADMIN']; ?> has to wait more than 5 minute to start the actual <?php echo $langage_lbl_admin['LBL_TRIP_TXT_ADMIN']; ?>.'></i></label>
                                        </div>
                                        <div class="col-lg-6">
                                            <input type="text" class="form-control" name="iWaitingFeeTimeLimit"  id="iWaitingFeeTimeLimit" value="<?= $iWaitingFeeTimeLimit; ?>" >
                                        </div>
                                    </div>
                                    <div class="row">
                                            <div class="col-lg-12">
                                                <label> Waiting Charges  (Price In <?=$db_currency[0]['vName']?>)<span class="red"></span> <i class="icon-question-sign" data-placement="top" data-toggle="tooltip" data-original-title='The charge defined here will be applied in total fare when <?php echo $langage_lbl_admin['LBL_DRIVER_TXT_ADMIN']; ?> has to wait more than defined waiting time to start the actual <?php echo $langage_lbl_admin['LBL_TRIP_TXT_ADMIN']; ?> after marking as arrived.'></i></label>
                                            </div>
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" name="fWaitingFees"  id="fWaitingFees" value="<?= $fWaitingFees; ?>">
                                            </div>
                                    </div>
                                    ...
                                    <div id="Regular_div2">   
                                                ...
                                                <div class="col-lg-12 main-table001">
                                                    <div class="main-table001">
                                                        ...
                                                        <table  class="col-lg-2">	
                                                            ...
                                                            <tr>
                                                                <td>  <input type="text" class="form-control" name="fMonPickUpPrice"  id="fMonPickUpPrice" value="<?= $fMonPickUpPrice; ?>" placeholder="Enter Price"  ></td><!-- onchange="getpriceCheck_digit(this.value)" -->
                                                            </tr>
                                                        </table>
                                                        ...
                                                        <table   class="col-lg-2">	
                                                            ...
                                                            <tr>
                                                                <td> <input type="text" class="form-control" name="fTuePickUpPrice"  id="fTuePickUpPrice" value="<?= $fTuePickUpPrice; ?>" placeholder="Enter Price" ></td><!-- onchange="getpriceCheck_digit(this.value)" -->
                                                            </tr>
                                                        </table>
                                                        ...
                                                        <table    class="col-lg-2">	
                                                            ...
                                                            <tr>
                                                                <td>  <input type="text" class="form-control" name="fWedPickUpPrice"  id="fWedPickUpPrice" value="<?= $fWedPickUpPrice; ?>"  placeholder="Enter Price" ></td> <!-- onchange="getpriceCheck_digit(this.value)" -->
                                                            </tr>
                                                        </table>
                                                        ...
                                                        <table   class="col-lg-2">	
                                                            ...
                                                            <tr>
                                                                <td>  <input type="text" class="form-control" name="fThuPickUpPrice"  id="fThuPickUpPrice" value="<?= $fThuPickUpPrice; ?>" placeholder="Enter Price" ></td> <!-- onchange="getpriceCheck_digit(this.value)" -->
                                                            </tr>
                                                        </table>
                                                        ...
                                                        <table   class="col-lg-2">	
                                                            ...
                                                            <tr>
                                                                <td>  <input type="text" class="form-control" name="fFriPickUpPrice"  id="fFriPickUpPrice" value="<?= $fFriPickUpPrice; ?>" placeholder="Enter Price"  ></td> <!-- onchange="getpriceCheck_digit(this.value)" -->
                                                            </tr>
                                                        </table>
                                                        ...
                                                        <table   class="col-lg-2">	
                                                            ...
                                                            <tr>
                                                                <td>  <input type="text" class="form-control" name="fSatPickUpPrice"  id="fSatPickUpPrice" value="<?= $fSatPickUpPrice; ?>" placeholder="Enter Price" ></td> <!-- onchange="getpriceCheck_digit(this.value)" -->
                                                            </tr></table>  	  
                                                        <table  class="col-lg-2">	
                                                            <tr>
                                                            ...
                                                            <tr>
                                                                <td>  <input type="text" class="form-control" name="fSunPickUpPrice"  id="fSunPickUpPrice" value="<?= $fSunPickUpPrice; ?>" placeholder="Enter Price" ></td><!-- onchange="getpriceCheck_digit(this.value)" -->
                                                            </tr>
                                                        </table>
                                                    </div>
                                                </div>
                                        ...
                                        <div id="shownighttime" style="display:none;">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6">
                                                    <input type="text" class="form-control" name="fNightPrice"  id="fNightPrice" value="<?= $fNightPrice; ?>" placeholder="Enter Price" >  <!-- onchange="getpriceCheck_digit(this.value);" -->
									...
									<div class="col-lg-12">
                                        <input type="submit" class="btn btn-default" name="btnsubmit" id="btnsubmit" value="<?= $action; ?> Service Type" >
...
//Change fields on the bases of service type

getServiceType();
$("#ServiceFeeType").change(function(){
  getServiceType();

});
//End Change fields on the bases of service type


//calculate fare or not
/*<?php if ($action=="Edit") { ?>
*/
/*<?php } ?>
*/$("#CalculateFare").change(function(){
    
 calculateFare_or_not();

});
calculateFare_or_not();
//End calculate fare or not

$("#is_payment_type").change(function(){
...
var is_payment_type=$("#is_payment_type option:selected").val();
if (is_payment_type.trim()=="Yes") 
{
$("#payment_type_row").css("display","");
$("#payment_type").attr("required","required");

} else
{
    $("#payment_type_row").css("display","none");
$("#payment_type").removeAttr("required");
}
}
function calculateFare_or_not()
{
    
    if ($("#CalculateFare option:selected").val()==false||$("#CalculateFare option:selected").val()=="false") {
    

                        $("#eFareType").removeAttr('required');
                        $("#row_eFareType").hide();
...
*/                        $("#fFixedFare").removeAttr('required');
 ...
 $("#eFareType").attr('required','required');
  $("#row_eFareType").show();
     /*$("#fFixedFare").attr('required','required');
    $("#fPricePerHour").attr('required','required')
...
//Function for Change fields on the bases of service type

function getServiceType(){


var feeType=$("#ServiceFeeType").val();
if (feeType.trim()=="1") 
{
$("#FixedCommisionDiv").css("display","none");
$("#FixedCommision").attr('required',false);

$("#fCommisionDiv").css("display",'');
$("#fCommision").attr('required',true);
}
else if(feeType.trim()=="2")
{
   $("#FixedCommisionDiv").css("display","");
$("#FixedCommision").attr('required',true);
$("#FixedCommisionlabel").text('Platform Fixed Fee');

$("#fCommisionDiv").css("display",'none');
$("#fCommision").attr('required',false); 
}
else if (feeType.trim()=="3") 
{
  $("#FixedCommisionDiv").css("display","");
$("#FixedCommision").attr('required',true);
$("#FixedCommisionlabel").text('Token Fee');

$("#fCommisionDiv").css("display",'none');
$("#fCommision").attr('required',false); 
}
else if(feeType.trim()=="4")
{
 $("#FixedCommisionDiv").css("display","");
$("#FixedCommision").attr('required',true);
$("#FixedCommisionlabel").text('Platform Fixed Fee');
...
else if(feeType.trim()=="6")
{
   $("#FixedCommisionDiv").css("display","");
$("#FixedCommision").attr('required',true);
$("#FixedCommisionlabel").text('Quantity based Fixed Fee');
...
$("#fCommision").attr('required',false); 
    ...
    $("#FixedCommisionDiv").css("display","none");
$("#FixedCommision").attr('required',false);
$("#FixedCommisionlabel").text('');

$("#fCommisionDiv").css("display",'none');
$("#fCommision").attr('required',false);  

$("#ServiceFeeType").attr('required',true);
}
}
