                            ...
                            <form id="_vehicleType_form" name="_vehicleType_form" method="post" action="" enctype="multipart/form-data">
                                ...
                                <?php if ($APP_TYPE == 'UberX') { ?> 
                                    ...
                                    <div id="Regular_div2">
                                        ...
                                        <div class="row">
                                                <div class="col-lg-12">
                                                    <label> Passenger Cancellation Charges<span class="red"></span> <i class="icon-question-sign" data-placement="top" data-toggle="tooltip" data-original-title='Passenger cancellation charges will be apply to the passenger when passenger cancels ride. Cancellation charges will apply for credit card payment only.'></i></label>
                                                </div>
                                                <div class="col-lg-6">
