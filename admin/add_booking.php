                ...
                <div class="inner" style="min-height: 700px;">
					...
					<form name="add_booking_form" id="add_booking_form" method="post" action="action_booking.php" >
						...
						<div class="form-group">
							<?php
								if(($APP_TYPE=='Ride-Delivery' || $APP_TYPE=='Ride-Delivery-UberX') && $APP_DELIVERY_MODE != "Multi"){  ?>
								...
								<!--<div class="col-lg-12 add-booking-radiobut">
									<input class="add-booking" id="r3" name="eType" type="radio" value="UberX" <?php if($etype == 'UberX') { echo 'checked'; } ?> onChange="show_type(this.value),showVehicleCountryVise($('#vCountry option:selected').val(),'<?php echo $iVehicleTypeId; ?>',this.value);">
								<label for="r3">Other Services</label></div>-->
								<? } ?>
							<?php } ?>
						</div>
						<div class="map-main-page-inner">
							...
							<? if($APP_TYPE != 'UberX'){ ?>
								<div class="total-price total-price1" style="display: none;"  > <b>Fare Estimation</b>
									<hr>
									<ul>
										<li id="MinFare">
											<b>Minimum Fare</b> :
										...
										<li id="DistanceFare">
											<b>Distance (<em id="dist_fare">0</em> <em id="change_eUnit"><? echo $DEFAULT_DISTANCE_UNIT;?></em>)</b> :
											<?php echo $generalobj->symbol_currency(); ?>
			...
			<script>
				...
				function setDriverListing(iVehicleTypeId) {
					...
					$.ajax({
						...
						dataType: "html",
						data: {vCountry: vCountry,type: '',iVehicleTypeId: iVehicleTypeId,keyword: keyword,eLadiesRide: eLadiesRide,eHandicaps: eHandicaps,dBooking_date:dBooking_date,AppeType:eType},
