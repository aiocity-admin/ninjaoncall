                      ...
                      <ul class="chat">
                        <?php if($n%2==0){ ?>
                         <li class="left clearfix">
                            ...
                            <? if($db_message[$i]['d_vImage']!='' && $db_message[$i]['d_vImage']!="NONE" && file_exists( "../webimages/upload/Driver/".$db_message[$i]['d_iDriverId']."/".$db_message[$i]['d_vImage'])){?>
                        ...
                        <?php } else { ?>
                             <li class="right clearfix">
                              ...
                              <? if($db_message[$i]['u_ImgName']!='' && $db_message[$i]['u_ImgName']!="NONE" && file_exists( "../webimages/upload/Passenger/".$db_message[$i]['u_iUserId']."/".$db_message[$i]['u_ImgName'])){?>
